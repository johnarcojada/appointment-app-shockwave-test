...
const Sidebar = () => {
  ...
  return (
    <div className='relative'>
      ...
      <motion.div
        className={`sidebar h-screen relative bg-gray-900 flex flex-col overflow-y-auto ${styles.sidebar} `}
        variants={sidebarAnim}
        animate={isSidenavCollapsed ? "collapsed" : "expanded"}
      >
        <div className='logo-container py-40 px-16 flex justify-center border-b border-b-gray-600 border-solid max-h-116'>
